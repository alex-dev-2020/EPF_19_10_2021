...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Версия", "2.0.15");    
	ПараметрыРегистрации.Вставить("Информация", "Альтерра  ВПФ ТЗ 2-х ст");   
	ТаблицаКоманд = ПолучитьТаблицуКоманд();
	ДобавитьКоманду(ТаблицаКоманд, "Альтерра  ВПФ ТЗ ВПФ ТЗ 2-х ст", "РеализацияТоваровИУслуг_Альтерра", "ВызовСерверногоМетода", Истина, "ПечатьMXL");
